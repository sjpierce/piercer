...
The goal of piercer is to provide a set of functions and files written for use 
...
be installed from [GitHub](https://github.com/) with the following code. If you 
don't have *devtools* installed, uncomment that line first. 
